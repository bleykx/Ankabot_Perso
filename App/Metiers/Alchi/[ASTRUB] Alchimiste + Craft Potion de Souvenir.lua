...
global:printMessage("Script réalisé par @Dampen59#4187.")
...
function move()
    ...
    if (map:currentArea() == "Astrub") then
        ...
        if (job:level(26) < 20) then
            GATHER = {254, 255, 84}
            return DeplacementsOrties()
        elseif (job:level(26) >= 20) then
            GATHER = {254, 255, 67, 66, 84}
            return DeplacementsOrtiesSauges()
        end
    end
end
...
function DeplacementsOrtiesSauges()
    return {
        {map = "5,-18", path = "top", gather = false, fight = false},
        {map = "5,-19", path = "left", gather = false, fight = false},
        {map = "4,-19", path = "left", gather = true, fight = false},
